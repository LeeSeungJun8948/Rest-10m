...
>>>>>>> branch 'master' of https://github.com/LeeSeungJun8948/Rest-10m.git
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="facAdmin.do">¼³ºñ °ü¸®</a>
                        <a class="collapse-item" href="facList.do">¼³ºñ Á¶È¸</a>
                        <a class="collapse-item" href="repList.do">¼³ºñ ¼ö¸®³»¿ª °ü¸®</a>
                        <a class="collapse-item" href="404.html">¼³ºñ Á¡°Ë³»¿ª °ü¸®</a>
                        <a class="collapse-item" href="facProdList.do">¼³ºñ»ý»êÀÌ·Â Á¶È¸</a>
                    </div>
                </div>
            </li>
