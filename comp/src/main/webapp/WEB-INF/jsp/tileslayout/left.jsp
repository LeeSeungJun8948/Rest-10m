            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="${pageContext.request.contextPath}/sym/ccm/cca/SelectCcmCmmnCodeList.do">공통코드관리</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/sym/ccm/cde/SelectCcmCmmnDetailCodeList.do">공통코드상세</a>
