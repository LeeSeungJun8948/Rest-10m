					...
					success : function(result) {
						...
						for (var i = 1; i < result.data.contents.length; i++) {
							...
							if (result.data.contents[i].chkURL == 'dir') {
								/* str += '<li class="nav-item"><a class="nav-link collapsed" data-toggle="collapse" href="#deExamples' + i + '"><i class="tim-icons icon-user-run"></i><p style="font-size:17px;">'
												+ result.data.contents[i].menuNm +  '<b class="caret"></b></p></a><div class="collapse" id="deExamples' + i +'"><ul class="nav">';	 */
								...
								/* str += '<li><a href="${pageContext.request.contextPath}' + result.data.contents[i].chkURL + '">'
									+ '<span class="sidebar-normal" style="font-size:15px;">'
									+ result.data.contents[i].menuNm
									+ '</span></a></li>'; */
