...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<div class="form-inline form-group">
			...
			<a class="btn-two small blue mr-4" href="<c:url value='/sym/prm/EgovProgramListRegist.do'/>" onclick="insertProgramListManage(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a><!-- 등록 -->
			<a class="btn-two small blue mr-4" href="#LINK" onclick="fDeleteProgrmManageList(); return false;" title='<spring:message code="button.delete" />'><spring:message code="button.delete" /></a><!-- 삭제 -->
	</div>
