			...
			<form id="inputFrm" name="inputFrm">
				...
				<table class="table">
					<tbody>
						<tr>
							<th>지시일자</th>
							<td><input type="date" id="orderDate" name="planDate"></td>
						</tr>
						<tr>
							<th>작업지시명</th>
		...
		<div class="mb-4 col-lg-6">
			...
			<div>
				<form id="dateFrm" name="dateFrm">
					<span>작업일자 </span><input type="date" id="planDtS" name="planDtS">
...
<script type="text/javascript" src="js/app/prod/prodOrderManage.js"></script>