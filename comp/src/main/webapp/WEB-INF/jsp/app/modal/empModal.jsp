...
<div id="modalContent">
	...
	<div class="modal-body">
		<form id="frmEmpModal" name="frmEmpModal">
			<div class="row">
				...
				<div class="col=md-1">
					<button id="btnReadModal" type="button" class="btn-two blue small">조회</button>
				</div>
			</div>
		</form>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/app/modal/empModal.js"></script>
</div>